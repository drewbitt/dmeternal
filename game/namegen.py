...
DEFAULT = NameGen( "ng_default.txt" )
DWARF = NameGen( "ng_dwarf.txt", min_syl=2, max_syl=3 )
DRAGON = NameGen( "ng_dragon.txt", max_syl=5 )
ELF = NameGen( "ng_elven.txt" )
ORC = NameGen( "ng_orc.txt" )
